...
`;
  ...
  // Removed defaultSummarizer test as it's not exported and llmSummarizer handles summarization
  // If a simple stringify behavior is needed, it should be part of llmSummarizer or a separate utility.
});
